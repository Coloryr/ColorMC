...
public partial class SettingModel
{
    ...
    private string GetRunType()
    {
        if (ColorMCGui.IsAot)
        {
            return LangUtils.Get("SettingWindow.Tab7.Text16");
        }
        else if (ColorMCGui.IsMin)
        {
            return LangUtils.Get("SettingWindow.Tab7.Text19");
        }
        return LangUtils.Get("SettingWindow.Tab7.Text17");
    }
    ...
    {
        var res = await Window.ShowChoice(LangUtils.Get("SettingWindow.Tab7.Text18"));
