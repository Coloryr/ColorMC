...
internal partial class X11Hook
{
    ...
    [LibraryImport("libX11")]
    public static partial void XWarpPointer(IntPtr display, IntPtr src_window, IntPtr dest_window, int src_x, int src_y, int src_width, int src_height, int dest_x, int dest_y);

    [LibraryImport("libX11")]
    public static partial void XFlush(IntPtr display);
    ...
    [LibraryImport("libX11")]
    public static partial int XQueryTree(IntPtr display, IntPtr window, ref IntPtr WinRootReturn,
    ...
    [LibraryImport("libX11")]
    public static partial uint XKeysymToKeycode(IntPtr display, uint keysym);
    ...
    public static readonly Dictionary<X11Key, Key> KeyFromX11Key = new()
    {
