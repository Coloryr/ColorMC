...
public enum PathType
{
    ...
    ServerPackPath, RunDir, JsonDir, BlockPath
}
...
public enum FileType
{
    ...
    User, Cmd, Icon, StartIcon, File, OpenLoaderDataPack, Lang
}
...
{
    ColorMC, CurseForge, Modrinth, MMC, HMCL, HMCLServer, ZipPack, LauncherPack
}
