...
for %%f in (%files%) do (
    move .\src\build_out\%1-dotnet\%%f .\src\build_out\%1-dotnet\colormc\%%f
)

set "zip_name=colormc-a%version%-%1.zip"

cd .\src\build_out\%1-dotnet\
powershell Compress-Archive -Path .\colormc -DestinationPath ..\..\..\build_out\%zip_name% -Force
...
for %%f in (%files%) do (
    move .\src\build_out\%1-aot\%%f .\src\build_out\%1-aot\colormc\%%f
)

set "zip_name=colormc-a%version%-%1-aot.zip"
